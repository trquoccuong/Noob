...
class DemoTable: UITableViewController,CrawlMachineDelegate {
    var data = [UnsplashImage]()
    var machine  = CrawlMachine()
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        var link = self.data[indexPath.row].url + "?q=50&fm=jpg&w=100&fit=max"
        cell.imageView?.image = UIImage(data: NSData(contentsOfURL: NSURL(string: link)!)!)
